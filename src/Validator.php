...
use ZanPHP\Support\Fluent;
use ZanPHP\Support\MessageBag;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \Zan\Framework\Utilities\Types\MessageBag
     */
    protected $messages;
    ...
    protected function initializeAttributeOnData($attribute)
    {
        ...
        return data_set($data, $attribute, null, false);
    }
    ...
    {
        if ($extensions) {
            $keys = array_map('\Zan\Framework\Utilities\Types\Str::snake', array_keys($extensions));
    ...
    {
        if ($replacers) {
            $keys = array_map('\Zan\Framework\Utilities\Types\Str::snake', array_keys($replacers));
